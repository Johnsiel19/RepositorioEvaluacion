<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="cCategorias.aspx.cs" Inherits="RegistroEvaluacion.Consultas.cCategorias" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

    
     <div class="panel" style="background-color: #ff7101">
        <div class="panel-heading" style="font-family: Arial Black; font-size: 20px; text-align:center; color: Black">Consulta de Categorias</div>
    </div>
    ...
    <div class="panel panel-primary">
        ...
        <asp:GridView ID="Grid" runat="server" class="table table-condensed table-responsive" AutoGenerateColumns="true" ShowHeaderWhenEmpty="True" DataKeyNames="CategoriaId" CellPadding="4" ForeColor="Black" GridLines="None">
            <EmptyDataTemplate>
